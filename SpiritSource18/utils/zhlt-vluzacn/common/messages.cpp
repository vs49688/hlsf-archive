...
static const MessageTable_t assumes[assume_last] = {
	...
	{"Exceeded MAX_MAP_LEAFS", "The maximum number of leafs for a map has been reached", simplify},
#endif
...
#ifdef HLRAD_TEXTURE
	{"Could not locate WAD file", "The compile tools could not locate a wad file that the map was referencing.", "Configure game directory pathes for hlrad in file '<tool path>\\settings.txt', and make sure this wad file either has been included into bsp by hlcsg or exists in one of the game directories."},
#endif
}; 
