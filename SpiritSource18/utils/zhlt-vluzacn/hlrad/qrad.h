...
#endif
#ifdef HLRAD_REFLECTIVITY
	#define DEFAULT_TEXREFLECTGAMMA 2.2f
...
#define PATCH_HUNT_OFFSET 1.0 //--vluzacn
...
extern vec_t *smoothvalues; //[nummiptex]
#endif
...
#ifdef HLRAD_SOFTSKY
extern void     BuildDiffuseNormals (int n);
#endif
...
#ifdef HLRAD_OPAQUE_BLOCK
extern int		TestPointOpaque (int modelnum, const vec3_t modelorigin, const vec3_t point);
#endif
#endif
...
#ifdef ZHLT_TEXLIGHT
#ifdef HLRAD_LERP_VL
extern void     SampleTriangulation(const lerpTriangulation_t* const trian, const vec3_t point, vec3_t result, int style); //LRC
#else
