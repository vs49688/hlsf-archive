...
public:
	...
	int VidInit( void );
	int Draw(float flTime);
	int DrawGameTitle(float flTime);
	int DrawMissionFailed(float flTime);
...
private:
	...
	float						m_gameMissionFailedTime;
	client_textmessage_t		*m_pGameTitle;
	client_textmessage_t		mMissionFailed;
	...
	int m_HUD_title_mission;
	int m_HUD_title_failed;
};
...
public:
	...
	int  _cdecl MsgFunc_VSys( const char *pszName, int iSize, void *pbuf );		//vs49688
	...
	int _cdecl MsgFunc_SetInput( const char *pszName, int iSize, void *pbuf );
	// Screen information
