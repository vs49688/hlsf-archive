...
#define DEATH_FADE_DURATION		5
#define DEATH_FADE_RENDER_AMT	200
#define DEATH_FADE_FLAGS		5
#define DEATH_FADE_RED			164
#define DEATH_FADE_GREEN		0
#define DEATH_FADE_BLUE			0
...
class CDeadPlayer : public CBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
	...
	// In order to specify the body type before spawn, we'll have to override the create function
	static CDeadPlayer * Create( int iBodyType, const Vector &vecOrigin, const Vector &vecAngles, edict_t *pentOwner );
	
	int m_iType;
	int m_iPose;
	int m_iSequence;
	static char *szDeathAnimations[3];
};
...
//	virtual void Think( void );
	...
	//HLSF Death Functions
	void StartDeath();
	void StopDeath();
	CDeadPlayer *pDeadPlayer;
