...
//LRC
#define GAME_NAME "Half-Life: Static Friction: Reborn"
...
public:
	...
	virtual BOOL FAllowFlashlight( CBasePlayer *pPlayer ) = 0;// Are players allowed to switch on their flashlight?
...
// GR_Think
	...
	virtual BOOL FAllowFlashlight( CBasePlayer *pPlayer );
