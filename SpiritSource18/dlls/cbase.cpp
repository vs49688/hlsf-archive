...
int CBaseEntity::Save( CSave &save )
{
	...
	{
		if (pev->targetname)
			return save.WriteFields( STRING(pev->targetname), "BASE", this, m_SaveData, HLARRAYSIZE(m_SaveData) );
		else
			return save.WriteFields( STRING(pev->classname), "BASE", this, m_SaveData, HLARRAYSIZE(m_SaveData) );
	}
