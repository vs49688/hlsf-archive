...
public:
	...
	int		m_iBaseBody; //LRC - for barniels with different bodies
	BOOL	m_fGunDrawn;
	float	m_painTime;
...
//=========================================================
Task_t	tlBarnielFollow[] =
{
	{ TASK_MOVE_TO_TARGET_RANGE,(float)128		},	// Move within 128 of target ent (client)
	{ TASK_SET_SCHEDULE,		(float)SCHED_TARGET_FACE },
};

Schedule_t	slBarnielFollow[] =
{
	{
		tlBarnielFollow,
		HLARRAYSIZE ( tlBarnielFollow ),
		bits_COND_NEW_ENEMY		|
...
Schedule_t slBarnielEnemyDraw[] = 
{
	{
		tlBarnielEnemyDraw,
		HLARRAYSIZE ( tlBarnielEnemyDraw ),
		0,
		0,
		"Barniel Enemy Draw"
	}
...
Schedule_t	slBarnielFaceTarget[] =
{
	{
		tlBarnielFaceTarget,
		HLARRAYSIZE ( tlBarnielFaceTarget ),
...
Schedule_t	slIdleBarnielStand[] =
{
	{ 
		tlIdleBarnielStand,
		HLARRAYSIZE ( tlIdleBarnielStand ), 
		bits_COND_NEW_ENEMY		|
		bits_COND_LIGHT_DAMAGE	|
		bits_COND_HEAVY_DAMAGE	|
		bits_COND_HEAR_SOUND	|
...
Schedule_t* CBarniel :: GetScheduleOfType ( int Type )
{
	...
	case SCHED_TARGET_FACE:
		...
		if (psched == slIdleStand)
			return slBarnielFaceTarget;	// override this for different target face behavior
		else
			return psched;

	case SCHED_TARGET_CHASE:
		return slBarnielFollow;
