...
public:
	...
	int		m_iBaseBody; //LRC - for kates with different bodies
	BOOL	m_fGunDrawn;
	float	m_painTime;
...
Schedule_t	slKateFollow[] =
{
	{
		tlKateFollow,
		HLARRAYSIZE ( tlKateFollow ),
		bits_COND_NEW_ENEMY		|
...
Schedule_t	slKateFaceTarget[] =
{
	{
		tlKateFaceTarget,
		HLARRAYSIZE ( tlKateFaceTarget ),
...
Schedule_t	slIdleKateStand[] =
{
	{ 
		tlIdleKateStand,
		HLARRAYSIZE ( tlIdleKateStand ), 
		bits_COND_NEW_ENEMY		|
		bits_COND_LIGHT_DAMAGE	|
		bits_COND_HEAVY_DAMAGE	|
		bits_COND_HEAR_SOUND	|
...
Schedule_t* CKate :: GetScheduleOfType ( int Type )
{
	...
	case SCHED_TARGET_FACE:
		...
		if (psched == slIdleStand)
			return slKateFaceTarget;	// override this for different target face behavior
		else
			return psched;
